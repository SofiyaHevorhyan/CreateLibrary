...
int main(int argc, char *argv[]) {
    ...
    const char str13_c[128] = "bagirls";
    my_str_from_cstr(&str13, str13_c, 128);

    printf("Strings %s and %s are equal: %d.\n\n", str13.data, str13_c, my_str_cmp(&str13, str13_c));
    printf("Inserted 'b' into the position 2 in string %s: ", str13.data);
    my_str_insert_c(&str13, 'b', 2);
    printf("%s\n", str13.data);

    printf("Inserted 'aba' into the position 3 in string %s: ", str13.data);
    my_str_t str14;
    my_str_create(&str14, 1024);
    const char *str14_c = "aba";
    my_str_from_cstr(&str14, str14_c, 128);

    my_str_insert(&str13, &str14, 3);
    printf("%s\n", str13.data);

    printf("Inserted C string 'aba' into the position 2 in string %s: ", str13.data);
    my_str_insert_cstr(&str13, str14_c, 2);
    printf("%s\n", str13.data);
